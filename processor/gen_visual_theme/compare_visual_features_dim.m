classdef compare_visual_features_dim
    ...
    methods
        function clusters = LoadCluster(obj, method_name) 
            if (strcmp(method_name, '256')) 
                input = load(sprintf('C:/Iconic/data/iconic_result/%s/result_256_iconic_love_all_large_scale_all_data_2.mat', obj.query));
                clusters = input.result{1}.clusters;
                clear input;
            elseif (strcmp(method_name, '500')) 
                input = load(sprintf('C:/Iconic/data/iconic_result/%s/result_500_iconic_love_all_large_scale_all_data_2.mat', obj.query));
                clusters = input.result{1}.clusters;
                clear input;
            elseif (strcmp(method_name, '1000')) 
                input = load(sprintf('C:/Iconic/data/iconic_result/%s/result_1000_iconic_love_all_large_scale_all_data_2.mat', obj.query));
                clusters = input.result{1}.clusters;
                clear input;
            elseif (strcmp(method_name, '2000_1000_tag_cluster')) 
                input = load(sprintf('C:/Iconic/data/iconic_result/%s/result_2000_iconic_love_all_large_scale_all_data_4.mat', obj.query));
                clusters = input.result{1}.clusters;
                clear input;
            elseif (strcmp(method_name, '2000_1500_tag_cluster')) 
                input = load(sprintf('C:/Iconic/data/iconic_result/%s/result_2000_iconic_love_all_large_scale_all_data_3.mat', obj.query));
                clusters = input.result{1}.clusters;
                clear input;
            elseif (strcmp(method_name, '2000_2000_tag_cluster')) 
                input = load(sprintf('C:/Iconic/data/iconic_result/%s/result_2000_iconic_love_all_large_scale_all_data_5.mat', obj.query));
                clusters = input.result{1}.clusters;
                clear input;
            elseif (strcmp(method_name, 'merged_1500_tag_cluster')) 
                input = load(sprintf('C:/Iconic/data/iconic_result/%s/result_2000_iconic_love_all_large_scale_all_data_6.mat', obj.query));
                clusters = input.result{1}.clusters;
                clear input;                
            end
        end
...
%            method_name {end + 1} = '2000_1000_tag_cluster';
%            method_name {end + 1} = '2000_1500_tag_cluster';
            ...
            database = IconicDatabase(obj.query, 'C:', 6000);
            do_gen_webpage = 1;
                    ...
                    for t = 1:size(good_tag_id, 2)
                        ...
                        if (do_gen_webpage == 1)
                            ...
                            gen_image_list_v1(image_ids, ...
                                obj.query, ...
                                sprintf('visual_theme_%s_features_dim_large_scale_7', obj.query), ...
